...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-10-2014 a las 08:26:03
...
CREATE TABLE IF NOT EXISTS `areas` (
  `EDTArea` varchar(12) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `nombreArea` varchar(50) CHARACTER SET latin1 DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `correlativodisciplina` (
  ...
  `codDisciplina` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `disciplinas` (
  `codDisciplina` varchar(4) CHARACTER SET latin1 NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `documentos` (
  ...
  `EDTSubArea` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  `codDisciplina` varchar(3) CHARACTER SET latin1 DEFAULT NULL,
  `codTipoDocumento` varchar(3) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `grupostipodocumento` (
  `codGrupoTipoDocumento` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT '',
...
`codLog` int(7) NOT NULL,
  ...
  `accion` varchar(250) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `subareas` (
  `EDTSubArea` varchar(12) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `nombreSubArea` varchar(100) DEFAULT NULL,
  `EDTArea` varchar(12) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tiposdocumento` (
  `codTipoDocumento` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `nombreTipoDocumento` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `codGrupoTipoDocumento` varchar(3) CHARACTER SET latin1 DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `usuariosrevisandocumentos` (
  `codDocumento` varchar(30) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `codUsuario` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `versiones` (
  `codVersion` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `nombreVersion` varchar(50) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `gruposusuario`
MODIFY `codGrupoUsuario` tinyint(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `usuarios`
MODIFY `codUsuario` tinyint(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
